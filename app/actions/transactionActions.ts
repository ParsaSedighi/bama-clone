...
export async function acceptTransaction(transactionId: string) {
    ...
    try {
        ...
        if (transaction.advertisement.userId !== session.user.id) {
        ...
        console.error("Database error in acceptTransaction:", error);
    }
}
...
export async function rejectTransaction(transactionId: string) {
    ...
    try {
        ...
        console.error("Database error in rejectTransaction:", error);
    }
}
